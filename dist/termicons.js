!(function (t, e, n, r, o) {
    ...
    (e = function () {
        return (function (t) {
            ...
            function (t, e, n) {
                (t.exports = n(0)(!1)).push([
                    t.i,
                    '.ti-rotate-90{transform:rotate(90deg);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=1)"}.ti-rotate-180{transform:rotate(180deg);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=2)"}.ti-rotate-270{transform:rotate(270deg);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=3)"}.ti-flip-horizontal{transform:scaleX(-1);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=0, mirror=1)"}.ti-flip-vertical{transform:scaleY(-1);-ms-filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation=2, mirror=1)"}',
                    "",
                ]);
            },
            function (t, e, n) {
                "use strict";
                n.r(e),
                    n.d(e, "TermIconElement", function () {
                        return g;
                    });
                var r,
                    o,
                    ...
                    (function (t) {
                        ...
                        return (
                            ...
                            u(e, null, [{
                                    key: "getIconSvg",
                                    value: function (t, e) {
                                        var n = this.cdnUrl + "/line/ti-" + t + ".svg";
                                        return (
                                            "solid" === e ? (n = this.cdnUrl + "/solid/tis-" + t + ".svg") : "logo" === e && (n = this.cdnUrl + "/logos/til-" + t + ".svg"),
                                            (n && b[n]) ||
                                ...
                                },
                                {
                                    key: "cdnUrl",
                                    get: function () {
                                        return "//unpkg.com/termicons@1.0.0/svg";
                                    },
                                },
                                {
                                    key: "tagName",
                                        ...
                                        switch (t) {
                                            case "type":
                                                !(function (t, e, n) {
                                                    ...
                                                    r.type && (r.type = null),
                                                        (r.type = !n || ("solid" !== n && "logo" !== n) ? "line" : n),
                                            ...
                                            case "size":
                                                ...
                                                break;
                                            case "rotate":
                                                e && r.classList.remove("ti-rotate-" + e), n && r.classList.add("ti-rotate-" + n);
                                                break;
                                            case "flip":
                                                e && r.classList.remove("ti-flip-" + e), n && r.classList.add("ti-flip-" + n);
                                                break;
                                            case "animation":
                                                e && r.classList.remove("ti-" + e), n && r.classList.add("ti-" + n);
                                        }
                                    },
                                },
                                {
    ...
    "object" == typeof exports && "object" == typeof module ? (module.exports = e()) : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? (exports.TermIconElement = e()) : (t.TermIconElement = e());
});