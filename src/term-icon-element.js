...
export class TermIconElement extends HTMLElement {
    ...
    static getIconSvg(iconName, type) {
        var iconUrl = `${this.cdnUrl}/regular/ti-${iconName}.svg`;
        if (type === 'solid') {
            iconUrl = `${this.cdnUrl}/solid/tis-${iconName}.svg`;
        } else if (type === 'logo') {
            iconUrl = `${this.cdnUrl}/logos/til-${iconName}.svg`;
        }
